...
function lerMatrizAprovadaOrientacaoV01400_(ss) {
  ...
  dados.slice(1).forEach(function(linha) {
    ...
    mapa.set(chave, {
      ...
      antesDaQuestao: campo('como_trabalhar_antes'),
      duranteAQuestao: campo('como_trabalhar_durante'),
      depoisDaQuestao: campo('como_trabalhar_depois'),
      retomada: campo('intervencao_retomada'),
      mediacao: campo('intervencao_mediacao'),
      consolidacao: campo('intervencao_consolidacao'),
